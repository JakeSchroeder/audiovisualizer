...
class WEBGLAudioVisualizer {
    ...
    constructor(containerDOMNodeId: string, audioSource: string) {
        ...
        this.previousTime = 0;
        this.deltaTime = 0;
        this.integralSensitivityFactor = 0.4;
    ...
    private showParticles() {
        ...
        if (this.netAvgZHegith.length >= 1) this.netAvgZHegith.push(this.netAvgZHegith[this.netAvgZHegith.length - 1] + this.totalCurrentAvgZHeight);
